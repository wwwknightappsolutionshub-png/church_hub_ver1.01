...
export function YouthHubHero() {
  ...
  const headerRef = useModuleHeroStickyTitle('Youth Hub');
  ...
  return (
    <section ref={headerRef} className="relative overflow-hidden border-b" data-module-hero>
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-10 md:px-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-3 text-sm text-white/90 sm:text-base">{MODULE_DESCRIPTIONS.youth}</p>
            {ctx?.gamification && (
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 md:gap-3">
            {[
              ...
              >
                ...
                <p className="text-[10px] font-medium uppercase tracking-wide text-white/80">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
