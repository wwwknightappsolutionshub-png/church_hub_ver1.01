...
export const CELEBRATION_BRAND = '#1e3a5f';
export const CELEBRATION_ACCENT = '#c9a227';
export const CELEBRATION_BIRTHDAY_ACCENT = '#d97706';
export const CELEBRATION_ANNIVERSARY_ACCENT = '#7c3aed';

export function celebrationEmailShell(params: {
  eyebrow: string;
  headline: string;
  subhead?: string;
  bodyHtml: string;
...
export function celebrationHighlightBox(html: string, accent = CELEBRATION_ACCENT): string {
